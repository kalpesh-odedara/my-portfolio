...
const TerminalWidget = () => {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-xl overflow-hidden border border-primary/20 shadow-xl max-w-md w-full"
    >
      {/* Title bar */}
        ...
        <motion.div variants={stagger} initial="hidden" animate="show" className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <motion.div variants={item} className="flex-shrink-0 flex flex-col items-center gap-6">
            ...
            <div className="relative">
              <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-primary/30 glow">
          ...
          <div className="text-center lg:text-left max-w-2xl">
            ...
            {/* Social Links */}
            <motion.div variants={item} className="flex items-center gap-3 justify-center lg:justify-start mt-2">
              <a
                href="https://linkedin.com/in/kalpesh-odedara"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium bg-[#0A66C2]/10 text-[#0A66C2] border border-[#0A66C2]/30 hover:bg-[#0A66C2]/20 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium bg-secondary text-muted-foreground border border-border hover:text-foreground hover:bg-secondary/80 transition-colors"
              >
