...
const baselineDataset: KnowledgeItem[] = [
  ...
  { question: 'projects', answer: 'Kalpesh has built several impressive projects: DermAI (AI Hospital System), Role Assign System, Feedback System, and multiple E-commerce platforms like Furniture Shop and Alpha Wear.' },
  { question: 'dermai', answer: 'DermAI is a featured project: An AI-Powered Smart Hospital Management System with skin detection, a voice assistant, and mood analysis.' },
  ...
  { question: 'e-commerce', answer: 'Kalpesh has built several e-commerce sites: Furniture Shop (ASP.NET), Jewelry Shop (ASP.NET), and Alpha Wear (Fashion Store).' },
